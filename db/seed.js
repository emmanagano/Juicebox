...
async function dropTables() {
    ...
    try {
        ...
        `);
        console.log("Finished dropping tables!");//console.log
    } catch( error ) {
        console.error("Error dropping tables!");//console.log
        throw error;
...
async function createTables() {
    ...
    try {
        console.log("Starting to build tables...");//console.log
        await client.query(`
...
async function createInitialUsers() {
    ...
    try {
        console.log("Starting to create users...");//console.log
...
async function createInitialPosts() {
    ...
    try {
        console.log('Starting createInitialPosts');//console.log
...
async function createInitialTags() {
    try {
        ...
        console.log("Error creating tags! from createInitialTags");
        throw error;
    }
}
